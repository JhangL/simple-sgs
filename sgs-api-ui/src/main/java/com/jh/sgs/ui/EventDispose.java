...
//    }
    ...
    private boolean xzyx(XZYX xzyx) {
        ...
        println("输入对应武将id");
        player.submitWait=true;
        while (player.submitWait){
            try {
                Thread.sleep(100);
        ...
        String text = player.input.getText();
        player.input.setText("");
...
//    }
    ...
    private void println(String s) {
        player.pla.append("处理："+s+"\n");
        player.pla.selectAll();
    }
}
