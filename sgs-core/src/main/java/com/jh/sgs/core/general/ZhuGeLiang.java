    ...
    public void start() {
        ...
        InteractiveMachine.addEventInContext(getPlayerIndex(), "请将牌置于牌堆顶或底", new Interactiveable() {
            ...
            public InteractiveEvent.CompleteEnum complete() {
                if (a == b) return InteractiveEvent.CompleteEnum.COMPLETE;
                else if (a == 0) return InteractiveEvent.CompleteEnum.NOEXECUTE;
                else return InteractiveEvent.CompleteEnum.PROGRESS;
            }
